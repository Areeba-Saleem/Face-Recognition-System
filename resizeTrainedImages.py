...
for path, subdirnames, filenames in os.walk("/Users/areeb/PycharmProjects/test1/trainingImages"):
    for filename in filenames:
        if filename.startswith("."):
            print("Skipping File:", filename) # Skipping files that start with .
            continue
        ...
        new_path="resizeTrainingImages"+"/"+str(id)
