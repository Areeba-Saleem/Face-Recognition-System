...
# test_img = cv2.imread('/Users/areeb/PycharmProjects/test1/testImages/areeba2.jpg') # test_img path
...
# faces, faceID = fr.labels_for_training_data('/Users/areeb/PycharmProjects/test1/resizeTrainingImages')
...
while True:
    ...
    resized_img = cv2.resize(test_img, (1000, 700))
    cv2.imshow("face detection: ", resized_img)
    if cv2.waitKey(10) == ord('q'): # wait until key press
        break
cap.release()
cv2.destroyAllWindows()
